      ...
      <div className="hidden lg:flex lg:w-1/2 gradient-primary items-center justify-center relative overflow-hidden">
        ...
        <div className="text-center z-10 px-8">
          ...
          <p className="text-xl text-white/90 max-w-md">
            Start your productivity journey with us. Create an account and 
            transform the way you manage your tasks.
          </p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 bg-background">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Join TodoWeb and boost your productivity</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button 
              ...
              className="w-full h-12 gradient-primary text-white font-semibold hover-glow transition-all disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Register Now
            </Button>
